...
import { DailyData, CrowdfundingPayoutRecord } from "@/types/adminMetrics";

export default function CrowdfundingWeeklyChart() {
  const [allPayouts, setAllPayouts] = useState<CrowdfundingPayoutRecord[]>([]);
